...
> These bubble icons come from [ICONIC](https://github.com/YuheshPandian/ICONIC). Its gallery (`iconic-api.onrender.com/gallery`) currently covers general dev tools rather than AWS/Terraform/K8s-specific logos, so the rest of the stack below stays on shields.io badges until (or unless) matching icons are contributed.
